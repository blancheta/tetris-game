...
class GameMenu:
	...
	def __init__(self,screen, items, bg_color=(0,0,0),font=None, font_size=100, font_color=(255,255,255)):
		...
		# Menu Music
		self.menu_music = pygame.mixer.music.load('sounds/tetris-gameboy.mp3')
	...
	def run(self):
		...
		while mainloop:
			...
			if not self.start_selected or not self.settings_selected:
				...
				pygame.draw.rect(self.screen, (255,255,255), [posx-paddingx, posy-paddingy, width+paddingx+paddingx, height+paddingy], 2)
